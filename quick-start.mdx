---
title: "Quick start"
description: "Get your first AirTrigger agent running in 3 minutes using Claude Code."
---
...
<Step title="Create an AirTrigger account">

Sign up at [AirTrigger](https://airtrigger.io). The onboarding flow will guide you through creating your first organization and project.
