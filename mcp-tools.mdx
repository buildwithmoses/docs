...
title: "MCP Tools"
sidebarTitle: "Tools"
description: "Learn about how to use the tools available in the AirTrigger MCP Server"
---
...
Search the AirTrigger documentation for guides, examples, and API references.
...
List all projects in your AirTrigger account.

**Example usage:**
- `"What projects do I have?"`
- `"List my AirTrigger projects"`
...
- `"Set up a new AirTrigger project"`

### initialize_project

Initialize AirTrigger in your project with automatic setup and configuration.

**Example usage:**
- `"Set up AirTrigger in this project"`
- `"Add AirTrigger to my app"`
